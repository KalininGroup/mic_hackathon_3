...
<script>
  ...
  const sites = [
    ...
    { id:"site-fau", name:"Friedrich-Alexander-Universität", city:"Erlangen, Germany", lat:49.573187, lon:11.027062 },
    { id:"site-ucmerced", name:"University of California Merced", city:"Merced, CA, USA", lat:37.364688, lon:-120.424188 },
    { id:"site-baylor", name:"Baylor University", city:"Waco, TX, USA", lat:31.548313, lon:-97.113187 },
    ...
    { id:"site-nanosurf", name:"Nanosurf", city:"Liestal, Switzerland", lat:47.475812, lon:7.744312 },
    { id:"site-ut_austin", name:"University of Texas at Austin", city:"Austin, TX, USA", lat:30.285063, lon:-97.733563 },
  ];
  ...
  <div class="sites-grid">
    ...
    <div class="site-card" id="site-erc">
      ...
      <div class="site-meta">
        ...
        Contact: Bashir Kazimi
        <br><a href="mailto:b.kazimi@fz-juelich.de">b.kazimi@fz-juelich.de</a>
      </div>
      <div class="site-actions">
    ...
    <div class="site-card" id="site-ibec">
      ...
      <div class="site-meta">
        Barcelona, Spain • Building/Room: <em>TBA</em><br>
        Contact: Mauricio Cano
        <br><a href="mailto:mcano@ibecbarcelona.eu">mcano@ibecbarcelona.eu</a>
      </div>
      <div class="site-actions">
    ...
    <div class="site-card" id="site-felmi-zfe">
      ...
      <div class="site-meta">
        ...
        Contact: Michael Oberaigner
        <br><a href="mailto:michael.oberaigner@felmi-zfe.at">michael.oberaigner@felmi-zfe.at</a>
      </div>
      <div class="site-actions">
    ...
    <div class="site-card" id="site-uiuc">
      ...
      <div class="site-meta">
        Urbana–Champaign, IL • Building/Room: <em>MRL/Supercon 1002</em><br>
        Contact: <em>TBA</em>
      </div>
      <div class="site-actions">
    ...
    <div class="site-card" id="site-fau">
      <span class="badge">Germany</span>
      <h3>Friedrich-Alexander-Universität</h3>
      <img class="site-logo" src="{{ '/assets/FAU.svg' | relative_url }}" alt="Friedrich-Alexander-Universität logo" style="max-height:64px;">
      <div class="site-meta">
        Erlangen, Germany • Building/Room: <em>TBA</em><br>
        Contact: <em>TBA</em>
      </div>
      <div class="site-actions">
        <a href="https://maps.google.com/?q=Friedrich-Alexander-Universität" target="_blank" rel="noopener">Map</a>
        <a href="{{ '/registration/' | relative_url }}?site=Friedrich-Alexander-Universität%20-%20Erlangen,%20Germany" class="btn-primary">Register</a>
      </div>
    </div>
    <!-- University of California Merced -->
    <div class="site-card" id="site-ucmerced">
      <span class="badge">California, USA</span>
      <h3>University of California Merced</h3>
      <img class="site-logo" src="{{ '/assets/ucmerced.png' | relative_url }}" alt="UC Merced logo" style="max-height:64px;">
      <div class="site-meta">
        Merced, CA • Building/Room: <em>TBA</em><br>
        Contact: <em>TBA</em>
      </div>
      <div class="site-actions">
        <a href="https://maps.google.com/?q=University%20of%20California%20Merced" target="_blank" rel="noopener">Map</a>
        <a href="{{ '/registration/' | relative_url }}?site=University%20of%20California%20Merced" class="btn-primary">Register</a>
      </div>
    </div>
    <!-- Baylor University -->
    <div class="site-card" id="site-baylor">
      <span class="badge">Texas, USA</span>
      <h3>Baylor University</h3>
      <img class="site-logo" src="{{ '/assets/baylor.png' | relative_url }}" alt="Baylor University logo" style="max-height:64px;">
      <div class="site-meta">
        Waco, TX • Building/Room: <em>TBA</em><br>
        Contact: <em>TBA</em>
      </div>
      <div class="site-actions">
        <a href="https://maps.google.com/?q=Baylor%20University" target="_blank" rel="noopener">Map</a>
        <a href="{{ '/registration/' | relative_url }}?site=Baylor%20University" class="btn-primary">Register</a>
      </div>
    </div>
    ...
    <div class="site-card" id="site-iitd">
      ...
      <img class="site-logo" src="{{ '/assets/iitd.svg' | relative_url }}" alt="Indian Institute of Technology Delhi logo" style="max-height:64px;">
      <div class="site-meta">
        New Delhi, India • Building/Room: <em>TBA</em><br>
        Contact: Indrajeet Mandal
        <br><a href="mailto:srz228569@iitd.ac.in">srz228569@iitd.ac.in</a>
      </div>
      <div class="site-actions">
        <a href="https://maps.google.com/?q=IIT%20Delhi" target="_blank" rel="noopener">Map</a>
        <a href="{{ '/registration/' | relative_url }}?site=Indian%20Institute%20of%20Technology%20Delhi%20-%20New%20Delhi,%20India" class="btn-primary">Register</a>
      </div>
    </div>
    <!-- Linköping University - Linköping, Sweden -->
    <div class="site-card" id="site-liu">
      <span class="badge">Sweden</span>
      <h3>Linköping University</h3>
      <img class="site-logo" src="{{ '/assets/liu.svg' | relative_url }}" alt="Linköping University logo" style="max-height:64px;">
      <div class="site-meta">
        Linköping, Sweden • Building/Room: <em>Campus Valla, Building:TBA</em><br>
        Contact: Anna Elsukova
        <br><a href="mailto:anna.elsukova@liu.se">anna.elsukova@liu.se</a>
      </div>
      <div class="site-actions">
        <a href="https://maps.google.com/?q=Linköping%20University" target="_blank" rel="noopener">Map</a>
        <a href="{{ '/registration/' | relative_url }}?site=Linköping%20University%20-%20Linköping,%20Sweden" class="btn-primary">Register</a>
      </div>
    </div>
    <!-- Indian Institute of Science - Bengaluru, India -->
    <div class="site-card" id="site-iisc">
      <span class="badge">India</span>
      <h3>Indian Institute of Science</h3>
      <img class="site-logo" src="{{ '/assets/iisc.svg' | relative_url }}" alt="Indian Institute of Science logo" style="max-height:64px;">
      <div class="site-meta">
        Bengaluru, India • Building/Room: <em>TBA</em><br>
        Contact: TBA
        <!--<br><a href="mailto:EMAIL">EMAIL</a> -->
      </div>
      <div class="site-actions">
        <a href="https://maps.google.com/?q=IISc%20Bengaluru" target="_blank" rel="noopener">Map</a>
    ...
    <div class="site-card" id="site-nanosurf">
      <span class="badge">Switzerland</span>
      <h3>Nanosurf</h3>
      <img class="site-logo" src="{{ '/assets/nanosurf.svg' | relative_url }}" alt="Nanosurf logo" style="max-height:64px;">
      <div class="site-meta">
        Liestal, Switzerland • Building/Room: <em>Gräubernstrasse 12-14</em><br>
        Contact: Nanosurf Team
        <br><a href="mailto:copilot@nanosruf.com">copilot@nanosruf.com</a>
      </div>
      <div class="site-actions">
        <a href="https://maps.google.com/?q=Nanosurf%20Liestal" target="_blank" rel="noopener">Map</a>
        <a href="{{ '/registration/' | relative_url }}?site=Nanosurf%20-%20Liestal,%20Switzerland" class="btn-primary">Register</a>
      </div>
    </div>
    <!-- University of Texas at Austin -->
    <div class="site-card" id="site-ut_austin">
      <span class="badge">Texas, USA</span>
      <h3>University of Texas at Austin</h3>
      <img class="site-logo" src="{{ '/assets/ut_austin.svg' | relative_url }}" alt="UT Austin logo" style="max-height:64px;">
      <div class="site-meta">
        Austin, TX • Building/Room: <em>TBA</em><br>
        Contact: TBA
        <!--<br><a href="mailto:EMAIL">EMAIL</a> -->
      </div>
      <div class="site-actions">
        <a href="https://maps.google.com/?q=UT%20Austin" target="_blank" rel="noopener">Map</a>
        <a href="{{ '/registration/' | relative_url }}?site=University%20of%20Texas%20at%20Austin" class="btn-primary">Register</a>
      </div>
    </div>
    <!-- Online (no pin) -->
